...
inline void printUsage( std::FILE* out ) noexcept
{
    std::fprintf( out,
        ...
        "                               admitted while they fit and the first that does not stops the walk, so a bigger ceiling\n"
        "                               returns a SUPERSET rather than a repacked set. The sections= note reports how many were\n"
        "                               served of how many matched, dropped_by_budget= what the ceiling cost, and lines= the ranges\n"
        "                               actually PRESENT in the emitted body rather than the ones merely selected.\n"
