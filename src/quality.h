...
constexpr std::uint32_t kIngestCacheVersionMirror = 16;   // MUST equal ingest.cpp's kCacheVersion (gated)
constexpr std::uint32_t kIngestParserVerMirror    = 80;   // MUST equal ingest.cpp's kParserVer   (gated)
