    ...
    McpDispatchResult out;
    {
        ...
        else if( method == "tools/list" )
        {
            ...
            resp = "{\"jsonrpc\":\"2.0\",\"id\":" + id +
                   ...
                   "{\"name\":\"situational_awareness\",\"description\":\"The 5 things to know about a diff, as JSON: blast_radius, tests_to_run, forgotten (usual co-change partners missing from this diff — the Shotgun Surgery check), hotspot_alert, modules_touched. diff/files optional — defaults to 'git diff HEAD'. files is a STRING of comma-separated paths (files=\\\"src/a.cpp,src/b.h\\\"), not an array; an array is refused rather than read as absent, which would answer about the working tree instead of the files you named.\","
